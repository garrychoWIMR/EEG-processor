...
pop_writeeeg(EEG, [Settings.TargetFilePath, '.edf'], 'TYPE', 'EDF');
% ---------------------------------------------------------
% Update JSON
EEG.etc.JSON.Sources = fullpath2bidsuri(Settings.ProtocolPath, Settings.TargetFilePath);
...
fprintf(' - Finished in %s\n', datestr(now-T, 'HH:MM:SS')) %#ok<TNOW1,DATST>
% ---------------------------------------------------------
