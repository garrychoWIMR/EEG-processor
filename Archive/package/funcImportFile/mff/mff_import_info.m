function info = mff_import_info(file)
    ...
    while ~feof(id)
        ...
        switch section
            case 'fileInfo'
                [variables] = regexp(line, '<recordTime>(?<timestamp>[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}.[0-9]{3})(?<timestamp_submilliseconds>[0-9]{3})(?<timestamp_timezone>[-+][0-9]{2}:[0-9]{2})</recordTime>', 'names');
