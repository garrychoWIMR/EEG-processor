function [EEG, spindles] = Proc_SpindleDetection(EEG, Settings)
...
switch lower(Settings.Algorithm)
    case 'lacourse'
        DetSettings = DefaultSpindleDetectionSettings(EEG, 'lacourse');
        Settings = mergestruct(DetSettings, Settings);
