...
if exist('participants.tsv', 'file') == 2
    PHEN = readAndAppend(PHEN, 'participants.tsv');
elseif exist('participants.csv', 'file') == 2
    PHEN = readAndAppend(PHEN, 'participants.csv');
elseif exist('participants.txt', 'file') == 2
    PHEN = readAndAppend(PHEN, 'participants.txt');
end
